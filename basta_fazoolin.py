class Menu:
    ...
    def __repr__(self):
        return f'{self.name} menu available from {str(self.start_time)} to {str(self.end_time)}'
...
#print(({'pancakes': 7.50, 'home fries': 4.50, 'coffee': 1.50 }))
...
#print(brunch_menu.calculate_bill({'pancakes': 7.50, 'home fries': 4.50, 'coffee': 1.50 }))
